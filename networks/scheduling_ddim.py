#We didn't modify it any way, it is the same as the original code
import math
...
class DDIMScheduler():
    ...
    def add_noise(
        ...
        # assert not torch.isnan(sqrt_one_minus_alpha_prod).any().item(), "nan in sqrt_one_minus_alpha_prod"
        # assert not torch.isnan(sqrt_alpha_prod).any().item(), "nan in sqrt_alpha_prod"
